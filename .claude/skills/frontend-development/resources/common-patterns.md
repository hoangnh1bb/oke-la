...
## Authentication with useCurrentUser

### Getting Current User

```typescript
import { useCurrentUser } from '@/lib/queries/hooks';
...
**NEVER make direct API calls for auth** - always use `useCurrentUser` hook.
...
**Common Patterns:**
- ✅ useCurrentUser hook for current user (id, email, role, username)
