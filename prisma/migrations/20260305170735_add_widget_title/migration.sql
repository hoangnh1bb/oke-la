...
CREATE TABLE "new_SmartRecSettings" (
    ...
    "widgetTitle" TEXT NOT NULL DEFAULT 'Không chắc chắn? Khách hàng tương tự cũng xem những sản phẩm này.',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_SmartRecSettings" ("alternativeNudge", "comparisonBar", "createdAt", "enabled", "id", "maxAlternatives", "shop", "styleAccentColor", "styleBgColor", "styleBorderRadius", "styleButtonStyle", "styleCustomCSS", "styleFontSize", "stylePosition", "styleTextColor", "tagNavigator", "thresholdBrowsing", "thresholdConsidering", "thresholdHighIntent", "thresholdReadyToBuy", "thresholdStrongIntent", "trustNudge", "ucCartHesitationSec", "ucHesitationMax", "ucHesitationMin", "ucLostBackNavMin", "updatedAt") SELECT "alternativeNudge", "comparisonBar", "createdAt", "enabled", "id", "maxAlternatives", "shop", "styleAccentColor", "styleBgColor", "styleBorderRadius", "styleButtonStyle", "styleCustomCSS", "styleFontSize", "stylePosition", "styleTextColor", "tagNavigator", "thresholdBrowsing", "thresholdConsidering", "thresholdHighIntent", "thresholdReadyToBuy", "thresholdStrongIntent", "trustNudge", "ucCartHesitationSec", "ucHesitationMax", "ucHesitationMin", "ucLostBackNavMin", "updatedAt" FROM "SmartRecSettings";
