 ...
 * Order matters: first match wins (priority: UC-02 > UC-01 > UC-03 > UC-04).
 */
...
import { uc04CartDoubtHandler } from "./uc04-cart-doubt-trust-nudge.server";
...
export const useCaseHandlers: UseCaseHandler[] = [
  ...
  uc04CartDoubtHandler,         // Cart page idle detection
];
